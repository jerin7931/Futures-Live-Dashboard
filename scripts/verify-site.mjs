...
if(!home.includes('src="./screener/app.js?v=3.0.27-cutover"')||!home.includes("frame-src 'none';")||!home.includes('https://gbtjmhjhqhtnbswsylvd.supabase.co'))throw Error("Primary application / CSP regression");
