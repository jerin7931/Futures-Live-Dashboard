...
const files=["index.html","screener/index.html","screener/app.js","screener/dashboard-core.js","screener/demo-data.js","screener/workstation-view.js","screener/view.js","screener/styles.css","screener/canary.html","screener/canary.js","screener/qualification.html","screener/qualification.js","screener/qualification-core.js","config.js"];
...
for(const route of ["home","opportunities","market","sectors","news","watchlist"])if(!home.includes('data-route="'+route+'"'))throw Error("Missing route: "+route);
if(!home.includes('src="./screener/app.js?v=3.0.10"')||!home.includes("frame-src 'none';"))throw Error("Primary application / CSP regression");
...
console.log("FOS workstation bundle verified; six routes present; demo isolated; all JavaScript syntax checked.");
