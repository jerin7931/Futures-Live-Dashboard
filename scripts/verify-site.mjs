...
if(!home.includes('src="./screener/app.js?v=3.0.13"')||!home.includes("frame-src 'none';"))throw Error("Primary application / CSP regression");
if(!(await readFile(new URL("../screener/workstation-view.js",import.meta.url),"utf8")).includes('dashboard-core.js?v=3.0.13'))throw Error("Nested workstation route import is not cache-versioned");
